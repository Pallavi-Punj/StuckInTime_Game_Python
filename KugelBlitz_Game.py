...
def showInstructions():
    ...
    time.sleep(2)
    print('''
    Your spaceship has been damaged. To go back to your time-line you need to find materials to fix it.
    ...
    time.sleep(2)
    print('''
    You only have 3 attempts to answer the quetion.
    Scoring method:
        Correct answer on firt attempt gets 5 points
    ...
    time.sleep(3)
    print('''
    Every written answer is to be in small letters
...
def Check_Answer(Correct_Answer, Dialogue):
    ...
    while True:
        ...
        if Answer == Correct_Answer and attempt==0:
            ...
            time.sleep(1)
            print("            You failed to answer correctly. ")
            time.sleep(1)
...
def Update_Time(Total_Time):
    ...
    with open("gamedata.json", "w") as file:
        json.dump(gamedata, file)
    print(" ", name, "time taken to finish the game is", Total_Time, " seconds.")
    time.sleep(1)
    print(' ---------------------------\n')
    time.sleep(1)
...
def Question_3():
    print("""
        ...
        You have a cells to make up a battery. The bulb has a rating of (60W, 12V).
...
def Dialogue_7():
    ...
    time.sleep(1)
    print("""
    While you where having this epiphany, the box slips from your hand and hovers.
...
## Level 1
    while True:
        Question ="""What is the frequency of the sound, which you inquire about?
         (Hint: Answer in Hz)"""
    ...
    You take your highly advanced bikes and a device which collects data through sound.
    While moving through the forest, your device detects two types of sounds.
    One, infrared signatures of life by your thermal scanner and the second, an explainable sound,
    ...
    On your way you come across a group of humans.
    ...
    When you approach them, they seem surprised.""")
                time.sleep(1)
                print("""
    You ask them who there are, tell them about the signal you are receiving
    ...
    They don’t trust you. They say  """)
                ...
                print ('        ', Question)
                time.sleep(1)
                print("\n    You know that, based on the composition of your environment, the speed of sound is 340 m/s \n ")
            ...
            time.sleep(1)
            print("  Incorrect set of input, try again.")
            time.sleep(1)
...
## Level 5
    while True:
        ...
        which path should I take to minimise travel time so I can save my life
        and get away as fast as i can? """
        Correct_Answer = "cycloid"
        Dialogue = """\n    Just before the spiders could reach you, you jump.
    Lucky, you find your capsule at the end of the path. You get into it as fast as you can and wizz away into time. \n"""
    ...
    Think. THINK. \n""")
                ...
                Check_Answer(Correct_Answer, Dialogue)
                print ("  Reason for the answer")
                time.sleep(1)
                print ("""
  If light were to travel a path of refractive index
  which changes at each infinitesimal step, it would take the path of shortest time. \n
          sinx/(y^0.5)=constant
  x is the angle between the tangent to the curve and the vertical,
  y is the distance of the point on the curve from the start of the curve/descent \n
          x= a(t-sint) and y= a (1-cost)
  where t is the arc angle subtended by the point tracing the cycloid and the point of contact \n\n""")
                time.sleep(3)
                break
            else:
                print('  You can\'t go that way!')
...
## Level 6
    ...
    One thing you wonder is that, """)
        ...
        Should you tell them about the future invasion?
...
## Level 7
    ...
    while True:
        ...
        You realize therre isn't a clear distinction of tense."""
        Hint ="""
